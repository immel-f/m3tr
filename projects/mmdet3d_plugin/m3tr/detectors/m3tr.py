...
class M3TR(MVXTwoStageDetector):
    ...
    def forward_pts_train(self,
        ...
        outs = self.pts_bbox_head(
            pts_feats, lidar_feat, img_metas, prev_bev, gt_bboxes_3d=gt_bboxes_3d, gt_labels_3d=gt_labels_3d, gt_masked=gt_masked)
    ...
    def forward_train(self,
        ...
        losses_pts = self.forward_pts_train(img_feats, lidar_feat, gt_bboxes_3d,
                                            ...
                                            gt_bboxes_ignore, prev_bev, gt_depth, gt_seg_mask, gt_pv_seg_mask, gt_masked)
    ...
    def simple_test_pts(self, x, lidar_feat, img_metas, prev_bev=None, rescale=False, gt_bboxes_3d=None, gt_labels_3d=None, gt_masked=None):
        """Test function"""
        outs = self.pts_bbox_head(x, lidar_feat, img_metas, prev_bev=prev_bev,
                                  gt_bboxes_3d=gt_bboxes_3d, gt_labels_3d=gt_labels_3d, gt_masked=gt_masked)
    ...
    def simple_test(self, img_metas, img=None, points=None, prev_bev=None, rescale=False, gt_bboxes_3d=None, gt_labels_3d=None, gt_masked=None, **kwargs):
        ...
        new_prev_bev, bbox_pts, assigned_preds = self.simple_test_pts(
            img_feats, lidar_feat, img_metas, prev_bev, rescale=rescale, gt_bboxes_3d=gt_bboxes_3d, gt_labels_3d=gt_labels_3d, gt_masked=gt_masked)
