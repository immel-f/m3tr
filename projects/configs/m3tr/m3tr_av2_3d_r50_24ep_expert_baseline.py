...
# what type of prior scenario expert is trained is specified by the labels on which the model is trained, e.g. here an expert for the centerlines only prior
ann_root = '/workspace/m3tr/gen_labels/argoverse20_centerline_only_geo_split/'
