...
map_classes = ['divider_dashed', 'divider_solid',
               'boundary', 'centerline', 'ped_crossing']
...
model = dict(
    ...
    pts_bbox_head=dict(
        ...
        use_learned_gt_queries=False,
        use_gt_pos_queries=False,
        use_gt_ref_points=False,
...
# what type of prior scenario model is trained is specified by the labels, e.g. here an expert for the centerlines only prior
ann_root = '/workspace/m3tr/gen_labels_nuscenes/centerline_only_geo_split/'
...
train_pipeline = [
    ...
    dict(type='CustomPointToMultiViewDepth',
...
data = dict(
    ...
    val=dict(
        type=dataset_type,
        data_root=data_root,
        ann_file=ann_root + 'nuscenes_map_infos_temporal_val.pkl',
