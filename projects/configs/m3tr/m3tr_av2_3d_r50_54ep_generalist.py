...
model = dict(
    ...
    pretrained=dict(img='/workspace/m3tr/ckpts/resnet50-19c8e357.pth'),
    img_backbone=dict(
        type='ResNet',
        depth=50,
        num_stages=4,
...
data_root = '/datasets/public/argoverse20/'

#==============================================================================

# what type of prior scenario model is trained is specified by the labels, e.g. here a generalist 
ann_root = '/workspace/m3tr/gen_labels/argoverse2_cvpr_generalist_all_data_geo_split/'
